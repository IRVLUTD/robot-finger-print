...
- [Setup](#setup)
  - [Dataset \& Logs (Checkpoints) Prep](#dataset--logs-checkpoints-prep)
...
- [RFP Model](#rfp-model)
  - [Training](#training)
  - [Coordinate Map Inference](#coordinate-map-inference)
  - [Grasp Generation for target gripper](#grasp-generation-for-target-gripper)
  - [Grasp Evaluation](#grasp-evaluation)
...
- Script: `gcs_gdx_grasp_gen.py`
  ...
  - Please see the actual inference dir name under the logdir!  Also if its cumbersome to type this detailed inference dir, then see the last point under [Coordinate Map Inference](#coordinate-map-inference) for renaming/symlinking the chosen inference dir to just `inference`.
  - Example `inference-epoch=14-step=2460.ckpt-sharp_lift-debug-240909_131116`
the result from inference (coordinate map prediction). 
